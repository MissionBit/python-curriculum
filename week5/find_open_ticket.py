...
#You are selling tickets for your band concert. You want a way to let people know what the first available seat is
...
#When you find an empty seat, mark that one as sold to the current person so it cannot be sold again
